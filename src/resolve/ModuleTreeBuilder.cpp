...
namespace jc::resolve {
    ...
    def_id ModuleTreeBuilder::addDef(DefVis vis, const ast::ident_ptr & ident, DefKind defKind) {
    ...
    void ModuleTreeBuilder::enterModule(DefVis vis, const ast::ident_ptr & ident, DefKind defKind) {
